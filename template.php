...
<script>require = { paths: { 'vs': '<?php echo $developerpack_dir; ?>/vs' } };</script>
<script type="text/javascript" src="<?php echo $developerpack_dir; ?>/vs/loader.js"></script>
<script type="text/javascript" src="<?php echo $developerpack_dir; ?>/vs/language/map.js"></script>
<script>
	(function ($) {
